    ...
    do {
        ...
        switch (opcion) {
            ...
            case "2"://realizar giro
                //realizarGiro()
                alert("Haz seleccionado realizar un giro");
                retiro= parseInt(prompt("Ingresa el monto que deseas girar"));
                if (retiro>cliente.saldo) {
                    alert("Tu saldo suficiente para realizar la transaccion");
                } else {
                    cliente.saldo=cliente.saldo - retiro
                    alert("Haz realizado un retiro de: $ " + retiro);
            ...
            case "3"://realizar deposito
                //realizarDeposito()
                alert("Haz seleccionado realizar un deposito");
                ingreso= parseInt(prompt("Ingresa el monto que deseas depositar"));
                if (ingreso > 0) {
                    cliente.saldo=cliente.saldo+ingreso ; 
                  alert("Haz realizado un deposito de: $ " + ingreso);
                  alert("Tu saldo actual es: $ " +cliente.saldo)

                } else {
                    alert("El monto que debes depositar debe ser mayor a $ O , intenta nuevamente")   
                }
